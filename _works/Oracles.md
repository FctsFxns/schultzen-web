...
Experiences shared within the hosted encounters are translated into archetypes, figures, and situations, forming a language that operates across different registers: mystical, political, and embodied. The first and most concentrated articulation of this process is the [Drug Tarot](https://www.christinaschultz.com/shop-tarot/), a deck of cards based on archetypes emerging from situations of drug use.

This system expands into further oracles, including a BDSM Oracle and a Trans Oracle, extending the field of interpretation to other marginalised and embodied practices.
